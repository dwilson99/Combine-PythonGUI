...
class FileDialogDemo(EasyFrame):
    ...
    def __init__(self):
        ...
        self.addButton(text = "Open Target", row = 0, column = 0,
                       command = self.openFile)
        
        self.addButton(text = "Open Training Files", row = 0, column = 1,
                       command = self.openFile)
        
        self.addButton(text = "Run", row = 0, column = 2,
                       command = self.run)
        
        self.addButton(text = "Save As...", row = 0, column = 3,
  ...
  ######## Constants #####
        ...
        #    print args.targetFile
            ...
            with open (resultFile, 'w') as result_FH:
                ...
                with open (args.targetFile[0], 'rU') as target_FH:
                    specFields=[]
                    ipcFields=[]
                    cpcFields=[]
                    upcFields=[]
